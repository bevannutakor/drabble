...
export default function Privacy() {
  return (
   <div className={styles.container}>
    <Navbar />
    <h1 className='text-center mt-9'>Privacy Policy</h1>
<div className='text-center'>Last updated: July 18, 2022</div>
...
<br /><h1 className='text-center'>Interpretation and Definitions</h1>
...
<li>
<div><em>Application</em> means the software program provided by the Company downloaded by You on any electronic device, named Drabble</div>
</li>
<li>
<div><em>Company</em> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Drabble Inc, Vancouver, BC.</div>
</li>
<li>
...
<li>
<div><em>Personal Data</em> is any information that relates to an identified or identifiable individual.</div>
</li>
<li>
...
<li>
<div><em>Website</em> refers to Drabble, accessible from <a href="https://www.drabble.app" rel="external nofollow noopener" target="_blank">https://www.drabble.app</a></div>
</li>
<li>
...
<br /><h1 className='text-center'>Collecting and Using Your Personal Data</h1>
...
<br /><h1 className='text-center'>Children's Privacy</h1>
...
<br /><h1 className='text-center'>Links to Other Websites</h1>
...
<br /><h1 className='text-center'>Changes to this Privacy Policy</h1>
